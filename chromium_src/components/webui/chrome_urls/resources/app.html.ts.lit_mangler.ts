...
mangle((element) => {
  ...
  h2.textContent = 'List of Kilo URLs'
})
...
mangleAll((element) => {
  ...
  anchor.textContent = '\${info.url.url.replace(/chrome:/, "kilo:")}'
...
mangleAll((element) => {
  ...
  listItem.textContent = '\${info.url.url.replace(/chrome:/, "kilo:")}'
...
mangle((element) => {
  ...
  listItem.textContent = '\${url.url.replace(/chrome:/, "kilo:")}'
